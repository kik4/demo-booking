...
describe("formatDateStringYMD", () => {
  ...
  it("うるう年でない年の2月末を正しく処理する", () => {
    ...
    expect(result).toBe("2023/2/28");
  });

  it("異なる時刻フォーマットを正しく処理する", () => {
    expect(formatDateStringYMD("2024-06-29T10:30:45")).toBe("2024/6/29");
    expect(formatDateStringYMD("2024-06-29T10:30:45.123")).toBe("2024/6/29");
    expect(formatDateStringYMD("2024-06-29T10:30:45.123Z")).toBe("2024/6/29");
  });

  it("各月の末日を正しく処理する", () => {
    expect(formatDateStringYMD("2024-01-31T00:00:00.000Z")).toBe("2024/1/31");
    expect(formatDateStringYMD("2024-02-29T00:00:00.000Z")).toBe("2024/2/29"); // うるう年
    expect(formatDateStringYMD("2024-03-31T00:00:00.000Z")).toBe("2024/3/31");
    expect(formatDateStringYMD("2024-04-30T00:00:00.000Z")).toBe("2024/4/30");
    expect(formatDateStringYMD("2024-05-31T00:00:00.000Z")).toBe("2024/5/31");
    expect(formatDateStringYMD("2024-06-30T00:00:00.000Z")).toBe("2024/6/30");
    expect(formatDateStringYMD("2024-07-31T00:00:00.000Z")).toBe("2024/7/31");
    expect(formatDateStringYMD("2024-08-31T00:00:00.000Z")).toBe("2024/8/31");
    expect(formatDateStringYMD("2024-09-30T00:00:00.000Z")).toBe("2024/9/30");
